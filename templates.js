// Template HTML per le 4 slide del carosello Instagram giornaliero di Neural Agorà.
...
// Tronca un testo a una lunghezza massima senza spezzare le parole, aggiungendo "…" se serve.
  ...
  return page(`
    <div class="cover">
      <div class="header">
        ...
        <div class="wordmark serif">Neural Agorà</div>
      </div>
      <div class="middle">
...
function bloggerSlide({ title, excerpt }, image_url) {
  ...
  return page(`
    <div class="slide">
      <div class="header">
        <div class="dot"></div>
        <div class="brand">Neural Agorà</div>
      </div>
      <div class="title serif">${escapeHtml(truncate(title, 80))}</div>
...
function ctaSlide() {
  ...
  return page(`
    <div class="wrap">
      ...
      <div class="center">
        <div class="wordmark serif"><span class="n">NEURAL</span><span class="a">AGORÀ</span></div>
